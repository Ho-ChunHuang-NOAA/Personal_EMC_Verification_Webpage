...
function getURL(annual,month,domain,variable,validtime,site,indep,stat,frame){
...
function preload(obj){
	...
	for (i2=0; i2<hrs_loop.length; i2++){
		...
		var urls = getURL(obj.annual,obj.month,obj.domain,obj.variable,obj.validtime,obj.site,obj.indep,obj.stat,i);
