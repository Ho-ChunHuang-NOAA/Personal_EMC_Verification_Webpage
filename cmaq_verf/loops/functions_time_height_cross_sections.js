...
function getURL(annual,month,model,domain,variable,validtime,site,indep,frame){
...
function preload(obj){
	...
	for (i2=0; i2<hrs_loop.length; i2++){
		...
		var urls = getURL(obj.annual,obj.month,obj.model,obj.domain,obj.variable,obj.validtime,obj.site,obj.indep,i);
