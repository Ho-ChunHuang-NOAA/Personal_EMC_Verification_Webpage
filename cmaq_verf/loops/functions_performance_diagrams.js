...
function getURL(annual,month,day,domain,field,variable,validtime,indep,frame){
	var newurl = url.replace("YYYY",annual);
        newurl = newurl.replace("MM",month);
        newurl = newurl.replace('TTT',day);
...
function preload(obj){
	...
	for (i2=0; i2<hrs_loop.length; i2++){
		...
		var urls = getURL(obj.annual,obj.month,obj.day,obj.domain,obj.field,obj.variable,obj.validtime,obj.indep,i);
